...
const architectureProjects: ArchitectureProject[] = [
  ...
  {
    id: "doc-matcher",
    title: "Freight Doc Matcher Pipeline",
    tags: ["Python CLI", "OCR", "Claude AI"],
    description: "Python CLI that auto-matches Bill of Lading PDFs to Rate Confirmations using a hybrid extraction pipeline (native text → Tesseract OCR → Claude vision) and a 100-point additive scoring algorithm. Outputs a clickable Excel spreadsheet.",
    stats: [
