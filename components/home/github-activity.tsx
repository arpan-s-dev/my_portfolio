...
function SnakeAnimation() {
  ...
  // Arthur uses the green default (warmer overall card backdrop);
  // Atie uses the purple dark variant generated by the workflow.
  const src =
    theme === "arthur"
  ...
  return (
    <div
      className="mt-4 pt-4 border-t overflow-x-auto"
    ...
    >
      ...
      <img
        src={src}
        alt={`Animated snake eating the GitHub contribution grid for ${theme}`}
...
export function GitHubActivity({ contributions, username }: GitHubActivityProps) {
  ...
  return (
    ...
    >
      ...
      {/* Snake animation (lives on the `output` branch, generated by .github/workflows/snake.yml) */}
      <SnakeAnimation />
    </motion.div>
  )
}
