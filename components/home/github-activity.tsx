  ...
  return (
    ...
    >
      ...
      {/*
        ...
        - Snake SVG (preferred): generated by .github/workflows/snake.yml,
          already colored to match the heatmap palette via color_dots params.
          Always mounted so the <img> actually fetches and triggers onLoad;
          we just collapse it to height:0 while loading/error so the static
          heatmap fallback owns the layout, then expand to natural size once
          the SVG is decoded.
        - Negative -mx-6 -mb-6 escapes the card's p-6 padding so the snake
          renders edge-to-edge of the card — visibly larger and anchored to
          the bottom corners. overflow-hidden + rounded-b-[inherit] clips
          the SVG against the card's rounded bottom corners.
      */}
      <div
        className="-mx-6 -mb-6 overflow-hidden rounded-b-[inherit]"
        style={{ height: showSnake ? "auto" : 0 }}
        aria-hidden={!showSnake}
      >
        {/*
          aspect-ratio 880/150 with overflow:hidden crops out Platane/snk's
          built-in "stack" progress bar at viewBox y=144 plus the empty
          padding below it. The contribution grid sits at y=2-110 in
          viewBox coords, well within the kept top portion.
        */}
        <div
